...
NewElements=ar.NewElements~=false,
...
aa._PendingThemes=aa._PendingThemes or{}
function aa.AddTheme(ax,ay)
if aa.Themes then
aa.Themes[ay.Name]=ay
ao.Themes=aa.Themes
else
aa._PendingThemes[ay.Name]=ay
end
return ay
end
...
if aa._PendingThemes then
for k,v in pairs(aa._PendingThemes) do
aa.Themes[k]=v
end
aa._PendingThemes={}
end
...
local aB
if typeof(ay.Theme)=="table" then
aa.Themes[ay.Theme.Name]=ay.Theme
ao.Themes=aa.Themes
aB=ay.Theme
ay.Theme=ay.Theme.Name
else
aB=aa.Themes[ay.Theme or"Dark"]
end
